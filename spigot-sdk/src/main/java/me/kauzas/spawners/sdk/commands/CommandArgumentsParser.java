...
import me.kauzas.spawners.sdk.utils.ReflectionUtils;
...
public class CommandArgumentsParser {
    ...
    private Map<Field, Object> getArgumentFieldsAndValues(Type type) {
        Field[] fields = ReflectionUtils.getFieldsWithAnnotation((Class<?>) type, CommandArgument.class);
        ...
        Arrays.stream(fields).forEach(field -> {
            ...
            try {
                ...
                Object parsedValue = parser.parse(value, field);
