...
public class DomainEventRegisterer extends ReflectionRegisterer<DomainEventHandler> {
    /**
    ...
    /**
     * Constructor of {@link DomainEventRegisterer}.
     *
     * @param packagePath Package path to scan.
     * @param plugin      Plugin instance.
     */
    public DomainEventRegisterer(String packagePath, PluginBase plugin) {
