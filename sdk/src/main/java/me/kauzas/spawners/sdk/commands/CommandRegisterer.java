...
import me.kauzas.spawners.sdk.registerer.RegisterResult;
...
public class CommandRegisterer extends ReflectionRegisterer<AbstractCommand> {
    private final List<AbstractCommand> commands;
    private final CommandHandlerInterface handler;

    /**
     * Constructor of {@link CommandRegisterer}.
     *
     * @param packagePath Path of the package containing the commands.
     * @param plugin      Plugin instance.
     */
    public CommandRegisterer(String packagePath, PluginBase plugin, CommandHandlerInterface handler) {
     ...
     * @param plugin      Plugin instance.
     */
    public CommandRegisterer(String packagePath, PluginBase plugin) {
